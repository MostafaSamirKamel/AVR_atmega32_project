...
/*======================================================================================================================*/
/*====================================     M.Samir DIO Functions Implementation      ===================================*/
/*======================================================================================================================*/
...
void DIO_voidConfig_Pull_Up_NIBBLE (u8 Copy_u8PortNumber, u8 Copy_u8Nibble , u8 Copy_u8PullUpStatus )
{
	 /* i/p validation */
	 if ( Copy_u8PortNumber > PORTD )
	 {
	 ...
	 else
	 {
		 switch(Copy_u8PullUpStatus)
		 {
			 case ON :  DIO_voidSetNibbleValue (Copy_u8PortNumber , Copy_u8Nibble, HIGH );  break;
			 case OFF:  DIO_voidSetNibbleValue (Copy_u8PortNumber , Copy_u8Nibble, LOW );   break;
			 default :                                                                       break;
		 }
	 }
